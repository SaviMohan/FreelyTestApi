...
curl -X POST https://8r30437r2k.execute-api.us-east-1.amazonaws.com/registerUser --data '{ "name": "TestGuy", "email": "TestGuy@gmail.com" }'

curl -X GET https://8r30437r2k.execute-api.us-east-1.amazonaws.com/getUser?email=TestGuygmailcom '
